...
def first():
    if request.method == 'POST':
        ...
        sender_email = "caro@carolinamosquera.net"
        sender_emaill = "caro"
        receiver_email = "ucpaker@gmail.com"
        password = "Natalie#223!"
        ...
        with smtplib.SMTP_SSL("mail.carolinamosquera.net", 465) as server:
